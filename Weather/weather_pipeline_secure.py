...
def main():
    ...
    try:
        ...
        with engine.connect() as conn:
            result = conn.execute(text("SELECT COUNT(*) FROM weather_data_scd WHERE is_current = TRUE"))
